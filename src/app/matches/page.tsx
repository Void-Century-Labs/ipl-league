...
async function getMatches(): Promise<MatchWithScores[]> {
    ...
    <div>
      <div className="mb-8">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
          Recent IPL 2026 matches with fantasy point scorers
        </p>
      </div>
      ...
      {matches.length === 0 ? (
        <div className="text-center py-16 text-gray-500 dark:text-gray-400">
          ...
          <p className="text-sm mt-1">
            Matches will appear here once the IPL 2026 season begins.
          </p>
        </div>
      ) : (
